...
namespace math
{
    ...
    class catm_rom_spline : public spline<VALUE>
    {
    public:
        VALUE interpolate(float position) const
        {
            ...
            //поиск итераторов тех вершин сплайна, на основе которых строятся вычисления
    ...
    private:
        VALUE catmul_rom (VALUE p0, VALUE p1, VALUE p2, VALUE p3, float t) const
        {
            return        
                (
                    p1*2.f + 
