...
namespace rgde
{
	namespace render
	{
		...
		namespace details
		{
			...
			public:
				virtual ~geometry(){}
				static geometry* create(const vertex::VertexDecl decl, bool isDynamic);
		...
		public:
			...
			TGeometry(bool is_dynamic = false) : 
			m_impl(geometry::create(Vertex::GetDecl(), isDynamic)),
			...
			void render(primitive_type ePrimType = TriangleList)
			{
		...
		private:
			...
			std::auto_ptr<geometry>	m_spImpl;
			math::AABoxf				m_AABB;
