...
void System::makeLuaBinding(void)
{
	...
	module (m_scriptSys.LuaState())
		[
			...
			.def("drawImage", &RenderHelper::draw_image)
			.def("drawText", &RenderHelper::draw_text)
			,
			...
			.property("visible", &BaseWindow::get_visible, &BaseWindow::set_visible)
			//.def("setVisible", &BaseWindow::visible)
			//.def("getVisible", &BaseWindow::is_visible)
			.property("enabled", &BaseWindow::get_enable, &BaseWindow::set_enable)
			//.def("setEnabled", &BaseWindow::enable)
			//.def("getEnabled", &BaseWindow::enabled)
