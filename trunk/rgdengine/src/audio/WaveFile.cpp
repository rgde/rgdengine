...
bool WaveFile::Open(const char* strFileName, WAVEFORMATEX* pwfx)
{
    ...
    m_hmmio = mmioOpenA((char*)strFileName, NULL, MMIO_ALLOCBUF | MMIO_READ);
  ...
  //      if (NULL == (hResInfo = FindResourceA(NULL, strFileName, TEXT("WAVE"))))
  //      {
  //          if (NULL == (hResInfo = FindResourceA( NULL, strFileName, TEXT("WAV"))))
		//	{
